        ...
        <div className="w-full flex flex-col gap-16 md:gap-4">
          <div className="w-full flex flex-col gap-6">
            <h1 className="text-4xl font-bold text-slate-900 dark:text-slate-50">
              {t`AI Photo Extender: Expand Your Horizons with Creative Image Extensions`}
            </h1>
            <h2 className="text-slate-600 dark:text-slate-400">
              {t`Explore Beyond the Frame with AI Photo Extender: Seamlessly expand your photos online using advanced generative AI, ensuring high-quality visuals are maintained across all image ratios.`}
            </h2>
          </div>
