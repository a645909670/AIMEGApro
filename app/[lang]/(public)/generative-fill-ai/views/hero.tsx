        ...
        <div className="w-full flex flex-col gap-16 md:gap-4">
          <div className="w-full flex flex-col gap-6">
            <h1 className="text-4xl font-bold text-slate-900 dark:text-slate-50">
              {t`Generative Fill AI: Expand Your Horizons with Creative Image Extensions`}
            </h1>
            <h2 className="text-slate-600 dark:text-slate-400">
              {t`Explore Beyond the Frame with Generative Fill AI: Seamlessly expand your photos online using advanced generative AI, ensuring high-quality visuals are maintained across all image ratios.`}
            </h2>
          </div>
        ...
        <div className="w-full flex flex-col md:flex-row gap-6">
          <div className="w-full flex flex-col items-center justify-center gap-6">
            <div
              ...
              <img
                ...
                className="object-cover rounded-[2rem] rounded-tl-[2rem] rounded-br-[2rem]" alt='Before Photo Extender' />
              <div className="text-center mt-4">
                {t`Before Photo Extender`}
              </div>
            </div>
          ...
          <div
            ...
            <img
              ...
              className="object-cover rounded-[2rem] rounded-tl-[2rem] rounded-br-[2rem]" alt='After Photo Extender' />
            <div className="text-center mt-4">
              {t`After Photo Extender`}
            </div>
          </div>
